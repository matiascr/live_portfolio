defmodule LivePortfolioWeb.CoreComponents do
  @moduledoc """
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <select
        id={@id}
        name={@name}
        class="mt-1 block w-full py-2 px-3 border border-gray-500/75 bg-white rounded-md shadow-sm focus:outline-none focus:ring-zinc-500 focus:border-zinc-500 sm:text-sm"
        multiple={@multiple}
        {@rest}
      >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivePortfolioWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivePortfolioWeb.Gettext, "errors", msg, opts)
    end
  end
